...
LEVELLOADER.levelAlt3 = function(nextlvl,args) {
  var checkpt;
  if(args) {
    checkpt = JSON.parse(JSON.stringify(args));
  }
	GAMEMODEL.nextLevelUp = "endpath1";

  this.levelAlt3_base(checkpt);
  this.levelAlt3_dropper();

  GAMEMUSIC.currSong=0;
	//  GAMEMUSIC.playAudio();
};
LEVELLOADER.levelAlt3_base = function(checkpt)
{
...
LEVELLOADER.levelAlt3_dropper = function()
{
